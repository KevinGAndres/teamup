...
<section class="seccion_tarjetas d-flex flex-wrap justify-content-center gap-4 mt-5">
   ...
   <div class="tarjeta_torneo">
      <img src="{{ asset('imagenes/crea_torneo.png') }}" class="imagen_tarjeta">
      <div class="contenido_tarjeta text-center">
         <h4>Crear Torneo</h4>
         <p>Diseña y configura nuevos torneos.</p>
         <a href="{{ route('crear_torneo') }}" class="boton_entrar">Entrar</a>
      </div>
   </div>

   <div class="tarjeta_torneo">
      <img src="{{ asset('imagenes/convocatoria.jpg') }}" class="imagen_tarjeta">
      <div class="contenido_tarjeta text-center">
         <h4>Buscar Torneo</h4>
         <p>Explora torneos disponibles.</p>
         <a href="{{ route('buscar_torneo') }}" class="boton_entrar">Entrar</a>
      </div>
   </div>

   <div class="tarjeta_torneo">
      <img src="{{ asset('imagenes/amistoso.jpeg') }}" class="imagen_tarjeta">
      <div class="contenido_tarjeta text-center">
         <h4>Amistoso</h4>
